                                ...
                                <form class="" id="group_form" novalidate>
                                  <div class="row">
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control" id="grp_code" placeholder="Group Code" name="grp_code">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                      <label for="validationCustom01">Group Name</label>
                                      <input type="text" class="form-control" id="grp_name" placeholder="Group name" name="grp_name">
                                    </div>
                                    <div class="col-md-6 mb-3">
