                            ...
                            <form class="" id="activity" novalidate>
                              <div class="row">
                                <div class="col-md-6 mb-3">
                                  ...
                                  <input type="text" class="form-control" id="activity_code" placeholder="CODE" name="activity_code">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Activity Name</label>
                                  <input type="text" class="form-control" id="activity_name" placeholder="NAME" name="activity_name">
                                </div>
								               <div class="col-md-6 mb-3">
