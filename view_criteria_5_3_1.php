            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                  <h4 class="mb-0 font-size-18">Criteria 5.3.1 </h4>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="card-body">
                                <form class="" id="criteria_5_3_1" novalidate>
                              <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                 ...
                                 <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Name of the award/ medal </label>
                                  <input type="text" class="form-control" id="name_of_the_award " placeholder="name_of_the_award " name="name_of_the_award " onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Select appropriate event </label>
                                  <input type="text" class="form-control" id="select_appropriate_event" placeholder="select_appropriate_event" name="select_appropriate_event" onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Classification of event</label>
                                  <input type="text" class="form-control" id="classification_of_event" placeholder="classification_of_event" name="classification_of_event" onblur="validate_name_Input(this)">
                                </div>
                ...
                <table id="datatable1" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
                      ...
                      <th>Select appropriate event</th>
                      <th>Classification of event</th>
                      <th>proof_no</th>
                      <th>remark</th>
                      <th>Action</th>
                    </tr>
...
<script type="text/javascript" language="javascript" >
         $(document).ready(function(){
           var dataTable = $('#datatable1').DataTable({
            "ajax" : "fetch_data/get_criteria_5_3_1.php",
...
$(document).ready(function(){ 
	$(document).on('click', '.edit_data', function(){ 
           var id = $(this).attr("id"); 
           $.ajax({  
                url:"fetch/fetch_criteria_5_3_1.php",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
           ...
           $('#name_of_the_award ').val(data.name_of_the_award );
           $('#select_appropriate_event').val(data.select_appropriate_event);
           $('#classification_of_event').val(data.classification_of_event);
	  ...
	  $(document).on('click', '.delete_data', function(){
		 ...
		 if(checkstr == true){
           var id = $(this).attr("id");
		   				$.ajax({  
							url: "delete_details.php?page=criteria_5_3_1",
							type: "post",
							data: {id:id},
							success:function(data){ 
							if(data == 'DELETED'){
	  ...
	  $(document).on('click', '.change_status', function(){ 
		   ...
		   var value = $(this).attr("value"); 
           				$.ajax({  
							url: "change_status.php?page=criteria_5_3_1",
							type: "post",
