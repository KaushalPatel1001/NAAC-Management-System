...
include_once("include/db_connect.php");
	...
	if($page == "sub_group"){
		$id = $_POST['id'];
		$validate_delete = "delete from validation_log where ref_id = '$id' AND ref_mod ='validate_sub_group_mst'";
		$res = mysqli_query($conn,$validate_delete);
	...
	if($page == "weld"){
		$id = $_POST['id'];
		$ert = "delete from weld_consumable where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "add_inquiry_form"){
		$id = $_POST['id'];
		$ert = "delete from mst_inquiry where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "tpi"){
		$id = $_POST['id'];
		$ert = "delete from tpi where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "tpi2"){
		$id = $_POST['id'];
		$ert = "delete from tpi2 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "tpi1"){
		$id = $_POST['id'];
		$ert = "delete from tpi1 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_3_5_2"){
		$id = $_POST['id'];
		$ert = "delete from criteria_3_5_2 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_3_5_2_1"){
		$id = $_POST['id'];
		$ert = "delete from criteria_3_5_2_1 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_4_5_1_1"){
		$id = $_POST['id'];
		$ert = "delete from criteria_4_5_1_1 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_5_2_1_appeared"){
		$id = $_POST['id'];
		$ert = "delete from criteria_5_2_1_appeared where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_5_2_2_1"){
		$id = $_POST['id'];
		$ert = "delete from criteria_5_2_2_1 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "criteria_5_2_2"){
		$id = $_POST['id'];
		$ert = "delete from criteria_5_2_2 where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "weekly"){
		$id = $_POST['id'];
		$ert = "delete from weekly where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "product"){
		$id = $_POST['id'];
	$validate_delete = "delete from validation_log where ref_id = '$id' AND ref_mod ='validate_product_mst'";
		$res = mysqli_query($conn,$validate_delete);
		$ert = "delete from mst_product where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "manpower_category"){
		$id = $_POST['id'];
		$ert = "delete from manpower_category where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "manpower"){
		$id = $_POST['id'];
		$ert = "delete from manpower where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "group"){
		$id = $_POST['id'];
		$validate_delete = "delete from validation_log where ref_id = '$id' AND ref_mod ='validate_group_mst'";
		$res = mysqli_query($conn,$validate_delete);
	...
	if($page == "estimate"){
		$id = $_POST['id'];
		$ert = "delete from estimate_tab where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
	...
	if($page == "contract"){
		$id = $_POST['id'];
		$ert = "delete from contract where id='$id'";
		$rt = mysqli_query($conn,$ert);
		if($rt){
		echo "DELETED";
		}else{
