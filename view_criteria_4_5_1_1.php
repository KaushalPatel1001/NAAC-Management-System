            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                  <h4 class="mb-0 font-size-18">Criteria 4.5.1.1 E-content resources used by teachers /students for Academic year (June 2022-May 2023) 1. other MOOCs platforms 2.SWAYAM 3. Institutional LMS 4. e-PG-Pathshala Opt any 5. Any other Government Initiatives</h4>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="card-body">
                                <form class="" id="criteria_4_5_1_1" novalidate>
                              <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">type_of_expenditure</label>
                                  <input type="text" class="form-control" id="type_of_expenditure" placeholder="type_of_expenditure" name="type_of_expenditure" onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">total_amount_of_remuneration</label>
                                  <input type="text" class="form-control" id="total_amount_of_remuneration" placeholder="total_amount_of_remuneration" name="total_amount_of_remuneration" onblur="validate_name_Input(this)">
                                </div>
                               <div class="col-md-6 mb-3">
                ...
                <table id="datatable1" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
                      ...
                      <th>total_amount_of_remuneration </th>
                      <th>Action</th>
                    </tr>
                  </thead>
                </table>
...
<script type="text/javascript" language="javascript" >
         $(document).ready(function(){
           var dataTable = $('#datatable1').DataTable({
            "ajax" : "fetch_data/get_criteria_4_5_1_1.php",
...
$(document).ready(function(){ 
	$(document).on('click', '.edit_data', function(){ 
           var id = $(this).attr("id"); 
           $.ajax({  
                url:"fetch/fetch_criteria_4_5_1_1.php",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
                success:function(data){  
					 ...
					 $('#id').val(data.id); 
                    $('#type_of_expenditure').val(data.type_of_expenditure);
                    $('#total_amount_of_remuneration').val(data.total_amount_of_remuneration);
	  ...
	  $(document).on('click', '.delete_data', function(){
		 ...
		 if(checkstr == true){
           var id = $(this).attr("id");
		   				$.ajax({  
							url: "delete_details.php?page=criteria_4_5_1_1",
							type: "post",
							data: {id:id},
							success:function(data){ 
							if(data == 'DELETED'){
	  ...
	  $(document).on('click', '.change_status', function(){ 
		   ...
		   var value = $(this).attr("value"); 
           				$.ajax({  
							url: "change_status.php?page=criteria_4_5_1_1",
							type: "post",
