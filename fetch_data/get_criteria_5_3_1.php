...
include('../include/db_connect.php');
  ...
  $query = "SELECT * FROM criteria_5_3_1 ORDER BY id DESC";
...
/*  if($rows['status'] == '1'){
  ...
  $sub_array   = array();
    ...
    $sub_array[] = $rows['name_of_the_award'];
    $sub_array[] = $rows['select_appropriate_event'];
    $sub_array[] = $rows['classification_of_event']
