...
include('../include/db_connect.php');
	...
	$sub_array[] = '<td><a href="http://localhost/project/Criteria/Criteria%201/Criteria%201.1.php" id='.$rows["id"].' class="btn btn-outline-success btn-sm edit_data" data-toggle="modal" data-target="">Edit</a></td>';
	$data[]      = $sub_array;
}
$output = array(
 "data"       =>  $data
