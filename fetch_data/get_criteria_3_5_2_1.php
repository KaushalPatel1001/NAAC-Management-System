...
include('../include/db_connect.php');
  ...
  $query = "SELECT * FROM criteria_3_5_2_1 ORDER BY id DESC";
...
/*  if($rows['status'] == '1'){
  ...
  $sub_array   = array();
    $sub_array[] = $cou++;
    $sub_array[] = $rows['name_of_the_consultancy'];
    $sub_array[] = $rows['name_of_advisory'];
    $sub_array[] = $rows['consulting'];
    $sub_array[] = $rows['year'];
    $sub_array[] = $rows['month'];
    $sub_array[] = $rows['revenue_generated'];
