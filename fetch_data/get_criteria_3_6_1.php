...
include('../include/db_connect.php');
  ...
  $query = "SELECT * FROM criteria_3_6_1 ORDER BY id DESC";
...
/*  if($rows['status'] == '1'){
  ...
  $sub_array   = array();
    $sub_array[] = $cou++;
    $sub_array[] = $rows['year'];
    $sub_array[] = $rows['month'];
    $sub_array[] = $rows['name_of_the_activity'];
    $sub_array[] = $rows['organising_unit'];
    $sub_array[] = $rows['number_of_students_participated_in_such_activities'];
    $sub_array[] = $rows['number_of_teachers_participated_in_such_activities'];
    $sub_array[] = $rows['department'];
