            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                  <h4 class="mb-0 font-size-18">Criteria 3.5.2  Revenue generated from advisory / R&D consultancy projects including Clinical trials during the year </h4>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="card-body">
                                <form class="" id="criteria_3_5_2" novalidate>
                              <div class="row">
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Name of the consultancy</label>
                                  <input type="text" class="form-control" id="name_of_the_consultancy" placeholder="name_of_the_consultancy" name="name_of_the_consultancy" onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Name of advisory / R&D consultancy/clinical trial project</label>
                                  <input type="text" class="form-control" id="name_of_advisory" placeholder="name_of_advisory" name="name_of_advisory" onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">Consulting/Sponsoring agency with contact details</label>
                                  <input type="text" class="form-control" id="consulting" placeholder="consulting" name="consulting" onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                 ...
                                 <div class="col-md-6 mb-3">
                                  <label for="validationCustom01">revenue_generated </label>
                                  <input type="text" class="form-control" id="revenue_generated" placeholder="revenue_generated " name="revenue_generated " onblur="validate_name_Input(this)">
                                </div>
                                <div class="col-md-6 mb-3">
              ...
              <div class="card-body">
                <table id="datatable1" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
                      <th>Sr.No</th>
                      <th>name_of_the_consultancy</th>
                      <th>name_of_advisory</th>
                      <th>consulting</th>
                      <th>year</th>
                      <th>month</th>
...
<script type="text/javascript" language="javascript" >
         $(document).ready(function(){
           var dataTable = $('#datatable1').DataTable({
            "ajax" : "fetch_data/get_criteria_3_5_2.php",
...
$(document).ready(function(){ 
	$(document).on('click', '.edit_data', function(){ 
           var id = $(this).attr("id"); 
           $.ajax({  
                url:"fetch/fetch_criteria_3_5_2.php",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
                success:function(data){  
				 	 $('#name_of_the_consultancy').val(data.name_of_the_consultancy);
           $('#name_of_advisory').val(data.name_of_advisory);
           $('#consulting').val(data.consulting);
           $('#year').val(data.year);
           $('#month').val(data.month);
           $('#revenue_generated').val(data.revenue_generated);
	  ...
	  $(document).on('click', '.delete_data', function(){
		 ...
		 if(checkstr == true){
           var id = $(this).attr("id");
		   				$.ajax({  
							url: "delete_details.php?page=criteria_3_5_2",
							type: "post",
							data: {id:id},
							success:function(data){ 
							if(data == 'DELETED'){
	  ...
	  $(document).on('click', '.change_status', function(){ 
		   ...
		   var value = $(this).attr("value"); 
           				$.ajax({  
							url: "change_status.php?page=criteria_3_5_2",
							type: "post",
