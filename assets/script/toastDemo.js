(function($) {
  ...
  showDangerToast_uom_validation = function(){
    'use strict';
    resetToastPosition();
    $.toast({
      heading: 'Invalid Details',
      text: 'Purchase UOM and Inventory UOM should be same!',
      showHideTransition: 'slide',
      icon: 'warning',
      loaderBg: '#f2a654',
      position: 'top-right'
  ...
  showDangerToast_name_validation = function() {
    'use strict';
    resetToastPosition();
    $.toast({
    ...
    showDangerToast_code_validation = function() {
    'use strict';
    resetToastPosition();
    $.toast({
      heading: 'Invalid Input',
