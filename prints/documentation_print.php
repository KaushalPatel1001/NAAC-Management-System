...
<html>
   ...
   <body>
      <table cellpadding="3">
      <tr>
         <td style="width:100%; text-align:center;font-size:14px;color: #FFFFFF;background-color: #243F7D;">Documentation Charges</td>
       </tr>
        <tr>
         ...
         $sql = "SELECT * FROM documentation_charges";
        ...
        <tr>
            ...
            <td style="width:25%;border-top:1px solid black;border-right:1px solid black;text-align:center;border-bottom:1px solid black;"><b>'.$row['documentation_total_no'].'</b></td>
            <td style="width:25%;border-top:1px solid black;border-right:1px solid black;text-align:center;border-bottom:1px solid black;"><b>'.$row['documentation_unit_rate'].'</b></td>
            <td style="width:25%;border-top:1px solid black;border-right:1px solid black;text-align:center;border-bottom:1px solid black;"><b>'.$row['documentation_total_cost'].'</b></td>
        </tr>';
      }
